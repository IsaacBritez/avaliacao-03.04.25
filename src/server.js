...
const sequelize = require('./database/database'); // Importar a configuração do banco de dados
const Aluno = require('./models/aluno-models'); // Importar o modelo de usuário
